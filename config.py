...
class m:
    ...
    admin_direct = "https://t.me/talktotegs"
    main_msg = "🔘*MAIN MENU*"
    startmsg = """
...
\nFor 100% sure matches, join our VIP GAMES or else you may proceed to see today's free matches👇"""
    ...
    free_msg1 = "*TODAY'S FREE TIPS*\n\n*Use* /free  👈\n‼️_To get today's use command above to get the matches now_\nTo get premium highly fixed matches 👇"
    ...
    cs_msg1 = "🔘*CORRECT SCORE*\n\n*Games:* _2_\n*Odd:* •••\n*No loose:* Yes✅\n*Price:* _proceed to payments_\n\n_Use the main menu button 💰VIP-GAMES💰 then correct score to view today's ticket with actual odds_\n*Confirm* _And Proceed To Booking_"
